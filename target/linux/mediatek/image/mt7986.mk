...
define Device/xiaomi_redmi-router-ax6000-uboot
   ...
   DEVICE_DTS_DIR := $(DTS_DIR)/mediatek
   DEVICE_PACKAGES := kmod-leds-ws2812b luci-app-mtwifi l1profile wireless-tools kmod-conninfra kmod-warpkmod-mt_wifi ipv6helper kmod-mediatek_hnat bash autocore-arm mtkhnat_util
   UBINIZE_OPTS := -E 5
   BLOCKSIZE := 128k
   PAGESIZE := 2048
   KERNEL_IN_UBI := 1
